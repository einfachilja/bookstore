    ...
    <div id="content" class="content">
        <div class="contant-card">
          <div class="top-box">
            ...
            <div class="price-box">
            <span class="price-tag">${bookPrice
              .toString()
              .replace(".", ",")} EUR</span>
              <div class="like-box">
                <b>${bookLikes}</b>
            ...
            <div class="information-box">
                <span><h3>Author:</h3> ${bookAuthor}</span>
                <span><h3>Erscheinungsjahr:</h3> ${bookPublishedYear}</span>
                <span><h3>Genre:</h3>${bookGenre}</span>
            </div>
            <form>
             <h2>Kommentare</h2>
                Hier kommen die Kommentare hin!
            </form>
        </div>
    </div>`;
  }
